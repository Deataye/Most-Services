  ...
  return (
    <footer className="bg-[#0C0A28] text-white py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Bottom Links */}
        <div className="mt-2 pt-2 border-t border-gray-700 flex flex-col md:flex-row justify-between items-center">
        ...
        <div className="fixed bottom-4 right-4">
          <button className="bg-[#0492D3] hover:bg-purple-700 text-white p-3 rounded-lg shadow-lg flex items-center">
